  ...
  switch (process.argv[2]) {
    ...
    **/
    ...
    case "help":
      ...
      console.log();
      console.log(
        " Cache the response of a HTTP request inside a Redis list and let you manage your cache entries"
          .cyan
      );
      console.log();
      ...
      console.log(
        '     express-redis-cache add "home" "$(cat index.html)";'.cyan
      );
      ...
      console.log(
        " express-redis-cache connects to Redis using localhost as default and Redis default port. You can override that using the options: --port <port> --host <host>. Ditto for --prefix <prefix>."
          .cyan
      );
